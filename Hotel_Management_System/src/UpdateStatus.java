    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==check){
            ...
            try{
                ...
                // now is result ke according baaki ki filds fill krni hai
                while (rs.next()){
            ...
            try{
                conn conn = new conn();
                conn.s.executeUpdate("update customer set room = '"+room+"' ,number = '"+number+"', name = '"+name+"' , checkintime = '"+checkin+"' , deposit = '"+deposit+"' where number = '"+number+"'");
